    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          <h2 id="modal-title" className="text-lg font-semibold text-gray-900">Confirm Your Order</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div className="p-3 bg-primary-50 rounded-xl border border-primary-100">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                <p className="text-primary-700 font-medium">Monthly</p>
              ...
              <div>
                <p className="text-primary-700 font-medium">Interest</p>
              ...
              <div className="col-span-2 pt-2 border-t border-primary-200">
                ...
                <p className="text-primary-900 font-bold text-lg">₹{totalAmount?.toLocaleString() || 0}</p>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 py-3 px-4 border-2 border-gray-200 text-gray-600 font-medium rounded-xl hover:border-gray-300 hover:bg-gray-100 transition-colors"
            >
              Cancel
            </button>
            <button
              onClick={onConfirm}
              className="flex-1 py-3 px-4 bg-primary-600 text-white font-medium rounded-xl hover:bg-primary-700 transition-colors shadow-soft"
            >
              Confirm & Proceed
            </button>
          </div>
